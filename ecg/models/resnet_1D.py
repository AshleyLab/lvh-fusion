...
def convnx1(in_planes: int, out_planes: int, stride: int = 1, groups: int = 1, dilation: int = 1) -> nn.Conv1d:
...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = convnx1(inplanes, planes, stride)
        self.bn1 = norm_layer(planes)
        self.relu = nn.ReLU(inplace=True)
        self.conv2 = convnx1(planes, planes)
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.conv2 = convnx1(width, width, stride, groups, dilation)
...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.layer1, __ = self._make_layer(block, 64, layers[0])
        self.layer2, __ = self._make_layer(block, 128, layers[1], stride=2,
                                       dilate=replace_stride_with_dilation[0])
        self.layer3, __ = self._make_layer(block, 256, layers[2], stride=2,
                                       dilate=replace_stride_with_dilation[1])
        self.layer4, __ = self._make_layer(block, 512, layers[3], stride=2,
