'''
MOdified from : https://github.com/pytorch/vision/blob/2e8c124ff7266437efd37c7a23684f64fe6904cd/torchvision/models/densenet.py
'''
...
class DenseNet(nn.Module):
    ...
    def __init__(
        ...
        self.features = nn.Sequential(OrderedDict([
            ('conv0', nn.Conv1d(12, num_init_features, kernel_size=7, stride=2,
